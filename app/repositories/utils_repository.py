...
# Decorador mfa_required
def sp_verificar_mfa(id_usuario):
    """Retorna el estado del MFA del usuario: Doble_Factor_Activo y MFA_Secret"""
    resultado = db.call_procedure(
        "sp_tbl_usuario_verificar_mfa",
        (id_usuario,),
        commit=False
    )
